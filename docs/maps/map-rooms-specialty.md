...
Tài liệu này **thay thế** [`map detail.md`](./map%20detail.md) cho mục đích đối chiếu khoa phòng. Snapshot lấy từ database ngày **13/08/2026**.

- **Phòng vật lý / phòng logic / Area**: giữ nguyên dữ liệu map hiện tại (không chỉnh trong phase 1).
- **Khoa hiện tại**: `Room.specialty` sau khi rename phase 1 (`SP_12` → Nội tim mạch, `SP_15` → Sản phụ khoa, `SP_17` → Nội TK).
- **Khoa đề xuất**: độ chi tiết theo CSV *Func Reqs - Các khoa phòng*, **chưa gán lại Room** (phase 2).
...
| Specialty bệnh viện | 35 (28 mã `SP_*` + 7 khoa CSV mới, chưa có phòng) |
| AI_Specialty | 28 mã Infermedica |
| Mapping AI → khoa | 38 (28 primary identity + 10 mapping phụ) |
...
Cột **Khoa đề xuất** và **Mã AI** là đề xuất phase 2 / mapping CSV. Cột **Khoa hiện tại** là DB lúc snapshot.
...
| 2 | `G2.2.5` | Thủ thuật Nội khoa 1 | Phòng thủ thuật Nội khoa 1 | `PROCEDURE_ROOM` | Nội khoa | Nội tổng quát | `sp_1`, `sp_2` |
...
| 9 | `G2.2.12` | Tim mạch can thiệp 1 | Phòng Tim mạch can thiệp 1 | `CLINICAL_ROOM` | Nội tim mạch | **Ngoại tim mạch** | `sp_21` |
| 10 | `G2.2.13` | Tim mạch can thiệp 2 | Phòng Tim mạch can thiệp 2 | `CLINICAL_ROOM` | Nội tim mạch | **Ngoại tim mạch** | `sp_21` |
...
| 14 | `G2.2.17` | Thủ thuật Nội khoa 2 | Phòng thủ thuật Nội khoa 2 | `PROCEDURE_ROOM` | Nội khoa | Nội tổng quát | `sp_1`, `sp_2` |
| 15 | `G2.2.18` | Nội tổng quát 1 | Phòng Nội tổng quát 1 | `CLINICAL_ROOM` | Nội khoa | **Nội tổng quát** | `sp_1`, `sp_2` |
| 16 | `G2.2.19` | Nội tổng quát 2 | Phòng Nội tổng quát 2 | `CLINICAL_ROOM` | Nội khoa | **Nội tổng quát** | `sp_1`, `sp_2` |
| 17 | `G2.2.20` | Nội tổng quát 3 | Phòng Nội tổng quát 3 | `CLINICAL_ROOM` | Nội khoa | **Nội tổng quát** | `sp_1`, `sp_2` |
| 18 | `G2.2.21` | Thủ thuật Nội khoa 3 | Phòng thủ thuật Nội khoa 3 | `PROCEDURE_ROOM` | Nội khoa | Nội tổng quát | `sp_1`, `sp_2` |
...
| 26 | `G2.2.32` | Thủ thuật Nội khoa 4 | Phòng thủ thuật Nội khoa 4 | `PROCEDURE_ROOM` | Nội khoa | Nội tổng quát | `sp_1`, `sp_2` |
...
| 31 | `G2.2.41` | Thủ thuật Nội khoa 5 | Phòng thủ thuật Nội khoa 5 | `PROCEDURE_ROOM` | Nội khoa | Nội tổng quát | `sp_1`, `sp_2` |

### 2.6 Khu khám ngoại (`SUR`)

| STT | Physical | Tên physical | Logical room | `room_type` | Khoa hiện tại | Khoa đề xuất | Mã AI |
| :-: | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| 1 | `G2.4.12` | Ngoại tổng quát 1 | Phòng Ngoại tổng quát 1 | `CLINICAL_ROOM` | Ngoại khoa | **Ngoại tổng quát** | `sp_4` |
| 2 | `G2.4.13` | Thủ thuật Ngoại khoa 1 | Phòng thủ thuật Ngoại khoa 1 | `PROCEDURE_ROOM` | Ngoại khoa | Ngoại tổng quát | `sp_4` |
| 3 | `G2.4.14` | Ngoại tiết niệu | Phòng Ngoại tiết niệu | `CLINICAL_ROOM` | Tiết niệu | Tiết niệu | `sp_11` |
| 4 | `G2.4.15` | Ngoại lồng ngực | Phòng Ngoại lồng ngực | `CLINICAL_ROOM` | Ngoại khoa | **Ngoại lồng ngực** | `sp_4` |
| 5 | `G2.4.16` | Ngoại thần kinh 1 | Phòng Ngoại thần kinh 1 | `CLINICAL_ROOM` | Nội TK | **Ngoại TK** | `sp_4` |
| 6 | `G2.4.17` | Ngoại thần kinh 2 | Phòng Ngoại thần kinh 2 | `CLINICAL_ROOM` | Nội TK | **Ngoại TK** | `sp_4` |
| 7 | `G2.4.18` | Ngoại ung bướu | Phòng Ngoại ung bướu | `CLINICAL_ROOM` | Ung bướu | Ung bướu | `sp_13` |
| 8 | `G2.4.19` | Thủ thuật Ngoại khoa 2 | Phòng thủ thuật Ngoại khoa 2 | `PROCEDURE_ROOM` | Ngoại khoa | Ngoại tổng quát | `sp_4` |
| 9 | `G2.4.20` | Thủ thuật Ngoại khoa 3 | Phòng thủ thuật Ngoại khoa 3 | `PROCEDURE_ROOM` | Ngoại khoa | Ngoại tổng quát | `sp_4` |
| 10 | `G2.4.21` | Phụ khoa | Phòng Phụ khoa | `CLINICAL_ROOM` | Sản phụ khoa | Sản phụ khoa | `sp_15` |
| 11 | `G2.4.22` | Thủ thuật Ngoại khoa 4 | Phòng thủ thuật Ngoại khoa 4 | `PROCEDURE_ROOM` | Ngoại khoa | Ngoại tổng quát | `sp_4` |
...
| 15 | `G2.4.26` | Thủ thuật Ngoại khoa 5 | Phòng thủ thuật Ngoại khoa 5 | `PROCEDURE_ROOM` | Ngoại khoa | Ngoại tổng quát | `sp_4` |
...
CSV ghi `G2.4.34` là Đơn vị tiêm chủng. **DB là Khám sức khỏe — không đổi.**
...
Primary = khoa đang có phòng (hoặc identity `SP_*`) để auto-booking **không đổi hành vi**. Mapping phụ = khoa CSV, chờ phase 2 gán Room rồi đổi primary trên API admin.

| `ai_code` | Tên AI | Tên AI (VI) | Primary (khoa BV) | Mapping phụ |
| :--- | :--- | :--- | :--- | :--- |
| `sp_1` | General Practitioner | Bác sĩ đa khoa | Đa khoa (`SP_1`) | Nội tổng quát |
| `sp_2` | Internal Medicine Specialist | Bác sĩ nội khoa | Nội khoa (`SP_2`) | Nội tổng quát |
| `sp_3` | Pediatrician | Bác sĩ nhi khoa | Nhi khoa (`SP_3`) | — |
| `sp_4` | Surgeon | Bác sĩ ngoại khoa | Ngoại khoa (`SP_4`) | Ngoại tổng quát, Ngoại TK, Ngoại lồng ngực |
| `sp_5` | Gastroenterologist | Bác sĩ tiêu hóa | Tiêu hóa (`SP_5`) | — |
| `sp_6` | Orthopedist | Bác sĩ CTCH | Chấn thương Chỉnh hình (`SP_6`) | — |
| `sp_7` | Ophthalmologist | Bác sĩ mắt | Mắt (`SP_7`) | — |
| `sp_8` | Toxicologist | Bác sĩ chống độc | Chống độc (`SP_8`) | *(CSV không có)* |
| `sp_9` | Dermatologist | Bác sĩ da liễu | Da liễu (`SP_9`) | — |
| `sp_10` | Endocrinologist | Bác sĩ nội tiết | Nội tiết (`SP_10`) | — |
| `sp_11` | Urologist | Bác sĩ tiết niệu | Tiết niệu (`SP_11`) | — |
| `sp_12` | Cardiologist | Bác sĩ tim mạch | Nội tim mạch (`SP_12`) | — |
| `sp_13` | Oncologist | Bác sĩ ung bướu | Ung bướu (`SP_13`) | — |
| `sp_14` | ENT doctor | Bác sĩ tai mũi họng | Tai Mũi Họng (`SP_14`) | — |
| `sp_15` | Gynecologist | Bác sĩ phụ khoa | Sản phụ khoa (`SP_15`) | — |
| `sp_16` | Psychiatrist | Bác sĩ tâm thần | Tâm thần (`SP_16`) | — |
| `sp_17` | Neurologist | Bác sĩ thần kinh | Nội TK (`SP_17`) | — |
| `sp_18` | Dentist | Bác sĩ răng hàm mặt | Răng Hàm Mặt (`SP_18`) | — |
| `sp_19` | Infectologist | Bác sĩ truyền nhiễm | Truyền nhiễm (`SP_19`) | — |
| `sp_20` | Rheumatologist | Bác sĩ cơ xương khớp | Cơ xương khớp (`SP_20`) | VLTL-PHCN |
| `sp_21` | Angiologist | Bác sĩ mạch máu | Mạch máu (`SP_21`) | Ngoại tim mạch |
| `sp_22` | Diabetologist | Bác sĩ đái tháo đường | Đái tháo đường (`SP_22`) | Nội tiết |
| `sp_23` | Allergist | Bác sĩ dị ứng | Dị ứng (`SP_23`) | *(CSV không có)* |
| `sp_24` | Nephrologist | Bác sĩ thận học | Thận học (`SP_24`) | — |
| `sp_25` | Hematologist | Bác sĩ huyết học | Huyết học (`SP_25`) | — |
| `sp_26` | Neonatologist | Bác sĩ sơ sinh | Sơ sinh (`SP_26`) | Nhi khoa |
| `sp_27` | Pulmonologist | Bác sĩ hô hấp | Hô hấp (`SP_27`) | — |
| `sp_29` | Maxillofacial surgeon | Bác sĩ phẫu thuật hàm mặt | Phẫu thuật Hàm Mặt (`SP_29`) | Răng Hàm Mặt |
...
Giữ trong `Specialty`: Đa khoa, Chống độc, Dị ứng, Đái tháo đường, Mạch máu, Sơ sinh, Phẫu thuật Hàm Mặt, Nội khoa (ô dùm thủ thuật), Ngoại khoa (ô dùm thủ thuật + phòng chưa tách).

---

## 6. Phase 2 — gán lại Room (chưa làm)

Không sửa geometry / tên physical / logical. Chỉ đổi `Room.specialty_id`:

| Phòng | Từ | Sang |
| :--- | :--- | :--- |
| `G2.4.16`, `G2.4.17` Ngoại thần kinh | Nội TK | Ngoại TK |
| `G2.4.15` Ngoại lồng ngực | Ngoại khoa | Ngoại lồng ngực |
| `G2.4.12` Ngoại tổng quát 1 | Ngoại khoa | Ngoại tổng quát |
| `G2.4.13/19/20/22/26` Thủ thuật Ngoại | Ngoại khoa | Ngoại tổng quát |
| `G2.2.12`, `G2.2.13` Tim mạch can thiệp | Nội tim mạch | Ngoại tim mạch |
| `G2.2.18–20` Nội tổng quát | Nội khoa | Nội tổng quát |
| `G2.2.5/17/21/32/41` Thủ thuật Nội | Nội khoa | Nội tổng quát |

Sau khi gán phòng: admin đổi primary `sp_4` / `sp_21` / `sp_2` nếu muốn auto-booking đi theo khoa mới. `G2.4.34/35` Khám sức khỏe **không** chuyển.
