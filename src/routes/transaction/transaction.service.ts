...
export class TransactionService {
  ...
  constructor(private readonly payosService: PayosService, private readonly prismaService: PrismaService) {
  ...
  async create(createTransactionRequestDto: CreateTransactionRequestDto): Promise<ResponseType<any>> {
    try {
