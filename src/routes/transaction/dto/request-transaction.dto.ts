...
export class PayCashDto {
  ...
  @ApiProperty({
    name: 'service_order_id',
    description: 'ID của service order cần thanh toán tiền mặt',
    example: '97f0a82e-9d22-48ea-8b4e-9f37c35a8bc5',
  })
  service_order_id: string;
  ...
  @ApiProperty({
    name: 'clientId',
    description: 'ID của tài khoản lễ tân / bệnh nhân thực hiện thanh toán',
    example: '75a51e00-b2e7-447a-b39e-7c00a09cf15c',
  })
  clientId: string;

  @IsEnum(TransTypeEnum, { message: 'Transaction type không hợp lệ' })
  @ApiProperty({
    name: 'transType',
    enum: TransTypeEnum,
  ...
  @Min(1000, { message: 'Amount phải lớn hơn 1000' })
  @ApiProperty({
    name: 'amount',
