...
export class InfermedicaController {
  ...
  @ApiOkResponse({
    schema: {
      example: {
        ...
        "interview_token": "eyJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJQYXRpZW50RWR1Y2F0aW9uUmV2aXNpb25zIiwidG9rZW5QYXlsb2FkIjp7ImFnZUJ1bmRsZSI6ImFkdWx0IiwicGF0aWVudEVkdWNhdGlvblJldmlzaW9ucyI6e319LCJpYXQiOjE3ODE0NDcyMTN9.2-CUtL5YHGCdD9FsyW9j4TsNjfIaKEwulTYfG4Bybqc"
      }
    }
  })
  @Post("/diagnoise")
  ...
  recommendSpecialist(@Body() triageDto: TriageDto, @Query("interview_token") interview_token: string) {
    return this.infermedicaService.recommendSpecialist(triageDto, interview_token);
  }
